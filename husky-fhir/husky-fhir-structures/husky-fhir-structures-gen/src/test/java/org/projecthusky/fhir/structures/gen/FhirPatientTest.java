...
import org.projecthusky.fhir.structures.testhelper.TestPatient;
 ...
 *
 * @see org.org.projecthusky.fhir.structures.gen.FhirPatient
 */
class FhirPatientTest {
	...
	private Patient getPatient(TestPatient patientMueller) {
		...
		org.projecthusky.common.enums.AdministrativeGender gender;
		if ("male".equals(patientMueller.gender.toLowerCase())) {
			gender = org.projecthusky.common.enums.AdministrativeGender.MALE;
		} else if ("female".equals(patientMueller.gender.toLowerCase())) {
			gender = org.projecthusky.common.enums.AdministrativeGender.FEMALE;
		} else {
			gender = org.projecthusky.common.enums.AdministrativeGender.UNDIFFERENTIATED;
		}
...
//		assertEquals("StreetName", patient.getAddress().getStreetName());
	...
	void testFhirPatientAddress() {
		...
		final org.projecthusky.common.model.Patient conveniencePatient = new org.projecthusky.common.model.Patient(
				name, org.projecthusky.common.enums.AdministrativeGender.MALE,
				new GregorianCalendar());

		final org.projecthusky.common.model.Address address = new org.projecthusky.common.model.Address(
				new AddressBaseType());
	...
	void testFhirPatientMiddleName() {
		...
		final Patient conveniencePatient = new Patient(name,
                                                       org.projecthusky.common.enums.AdministrativeGender.MALE, new GregorianCalendar());
		final FhirPatient fhirPatient = new FhirPatient(conveniencePatient);
