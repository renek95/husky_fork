...
public class DocumentMetadataAt extends org.projecthusky.common.communication.DocumentMetadata {
	 ...
	 */
	public org.projecthusky.common.at.enums.FormatCode getFormatCodeEnum() {
	 ...
	 */
	public org.projecthusky.common.at.enums.HealthcareFacilityTypeCode getHealthcareFacilityTypeCodeEnum() {
	...
	public org.projecthusky.common.model.Person getLegalAuthenticator() {
		return new org.projecthusky.common.model.Person(getDocumentEntry().getLegalAuthenticator());
	}
	 ...
	 */
	public org.projecthusky.common.at.enums.PracticeSettingCode getPracticeSettingCodeEnum() {
	...
	public void setServiceEventCode(List<org.projecthusky.common.model.Code> codes) {
		if (codes != null && !codes.isEmpty()) {
			for (org.projecthusky.common.model.Code eventCode : codes) {
				if (eventCode != null) {
	...
	public void setServiceEventCode(org.projecthusky.common.model.Code eventCode) {
		if (eventCode != null) {
			getDocumentEntry().getEventCodeList().add(XdsMetadataUtil.convertEhcCodeToCode(eventCode));
		}
	}
	...
	public void setLegalAuthenticator(org.projecthusky.common.model.Person legalAuthenticator) {
