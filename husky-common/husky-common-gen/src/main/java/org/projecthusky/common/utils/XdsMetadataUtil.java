...
public class XdsMetadataUtil {
	...
	public static List<org.projecthusky.common.model.Telecom> convertIpfTelecoms(List<Telecom> xtnList) {
		final List<org.projecthusky.common.model.Telecom> t = new LinkedList<>();

		for (Telecom xtn : xtnList) {
			if (xtn != null && xtn.getType() != null) {
				var telecom = new org.projecthusky.common.model.Telecom();
