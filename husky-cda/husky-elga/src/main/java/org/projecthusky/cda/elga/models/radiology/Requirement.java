...
public class Requirement extends POCDMT000040Section {

    public Requirement() {
        super.getClassCode().add("DOCSECT");
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.5.2.1"));
        super.setCode(createHl7CodeFixedValue("55115-0",
