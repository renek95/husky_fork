...
public class ClinicalPresentation extends POCDMT000040Section {

    public ClinicalPresentation() {
        super.getClassCode().add("DOCSECT");
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.5.2.4"));
