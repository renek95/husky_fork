...
public class Recomendation extends POCDMT000040Section {

    public Recomendation() {
        super.getClassCode().add("DOCSECT");
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.5.2.13"));
        super.setCode(createHl7CodeFixedValue("18783-1",
