...
public class Summary extends POCDMT000040Section {

    public Summary() {
        super.getClassCode().add("DOCSECT");
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.5.2.10"));
        super.setCode(createHl7CodeFixedValue("55112-7",
