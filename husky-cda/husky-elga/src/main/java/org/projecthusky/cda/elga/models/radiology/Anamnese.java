...
public class Anamnese extends POCDMT000040Section {

    public Anamnese() {
        super.getClassCode().add("DOCSECT");
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.5.2.2"));
        super.setCode(createHl7CodeFixedValue("11329-0",
