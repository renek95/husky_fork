...
public class Indication extends POCDMT000040Section {

    public Indication() {
        super.getClassCode().add("DOCSECT");
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.5.2.3"));
        super.setCode(createHl7CodeFixedValue("18785-6",
