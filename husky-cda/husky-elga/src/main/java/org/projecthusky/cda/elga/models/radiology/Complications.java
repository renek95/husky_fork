...
public class Complications extends POCDMT000040Section {

    public Complications() {
        super.getClassCode().add("DOCSECT");
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.5.2.8"));
        super.setCode(createHl7CodeFixedValue("55109-3",
