...
public class Impression extends POCDMT000040Section {

    public Impression() {
        super.getClassCode().add("DOCSECT");
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.5.2.11"));
        super.setCode(createHl7CodeFixedValue("19005-8",
