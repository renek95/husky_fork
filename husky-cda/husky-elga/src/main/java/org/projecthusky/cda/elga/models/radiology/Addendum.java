...
public class Addendum extends POCDMT000040Section {

    public Addendum() {
        super.getClassCode().add("DOCSECT");
        super.getTemplateId().add(createHl7TemplateIdFixedValue("1.2.40.0.34.11.5.2.14"));
        super.setCode(createHl7CodeFixedValue("55107-7",
